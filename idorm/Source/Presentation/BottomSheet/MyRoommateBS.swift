...
final class MyRoommaateBottomSheet: BaseViewController {
  ...
  let chatButton = BSUtilities.basicButton("룸메이트와 채팅하기", image: #imageLiteral(resourceName: "speechBubble_small"))
  let reportButton = BSUtilities.reportButton()
  private let xmarkButton = BSUtilities.button(#imageLiteral(resourceName: "xmark_black"))
  ...
  override func setupStyles() {
    ...
    switch roommate {
    case .dislike:
      button = BSUtilities.basicButton("싫어요한 룸메에서 삭제", image: #imageLiteral(resourceName: "trash"))
    case .like:
      button = BSUtilities.basicButton("좋아요한 룸메에서 삭제", image: #imageLiteral(resourceName: "trash"))
    }
