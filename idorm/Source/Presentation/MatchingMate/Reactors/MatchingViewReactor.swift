...
//  
//  enum Action {
//    case buttonDidTap(MatchingMateButtonType)
//    
//    
//    case viewDidLoad
//    case viewWillAppear
...
//        .just(.setLoading(true)),
//        MatchingInfoAPI.provider.rx.request(.updateMatchingInfoForPublic(true))
//          .asObservable()
//          .retry()
...
//      return Observable.concat([
//        MatchingMateAPI.provider.rx.request(.createMatchingMate(false, id))
//          .asObservable()
//          .retry()
...
//      return Observable.concat([
//        MatchingMateAPI.provider.rx.request(.createMatchingMate(true, id))
//          .asObservable()
//          .retry()
//          .debug()
...
//    return MatchingMateAPI.provider.rx.request(.getMembers)
//      .asObservable()
//      .retry()
//      .filterSuccessfulStatusCodes()
//      .flatMap { response -> Observable<Mutation> in
...
//      .getFilteredMembers(filter: filter)
//    )
//      .asObservable()
//      .retry()
//      .debug()
