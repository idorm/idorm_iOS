...
class CommunityUtilities {
  ...
  static func getReportButton() -> UIButton {
    ...
    titleContainer.font = UIFont.init(name: Font.medium.rawValue, size: 20)
  ...
  static func getBasicButton(title: String, imageName: String) -> UIButton {
    ...
    container.font = UIFont.init(name: Font.medium.rawValue, size: 20)
  ...
  static func getDormNumberButton(title: String) -> UIButton {
    var config = UIButton.Configuration.filled()
    var container = AttributeContainer()
    container.font = UIFont.init(name: Font.bold.rawValue, size: 20)
    container.foregroundColor = UIColor.black
    config.attributedTitle = AttributedString(title, attributes: container)
    let button = UIButton(configuration: config)
    button.contentHorizontalAlignment = .leading
